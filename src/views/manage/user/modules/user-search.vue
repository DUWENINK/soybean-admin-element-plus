          ...
          <ElRow :gutter="24">
            ...
            <ElCol :lg="6" :md="8" :sm="12" :label="$t('page.manage.user.userGender')">
              <ElFormItem :label="$t('page.manage.user.userGender')" prop="search.userGender">
                <ElSelect
                  v-model="model.search.userGender"
                  clearable
            ...
            <ElCol :lg="6" :md="8" :sm="12">
              <ElFormItem :label="$t('page.manage.user.userStatus')" prop="search.status">
                <ElSelect v-model="model.search.status" clearable :placeholder="$t('page.manage.user.form.userStatus')">
                  <ElOption
